...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Fartcoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Fartcoin values
        ...
        vSeeds.push_back(CDNSSeedData("multifart.org", "seed.multifart.org", true));
        vSeeds.push_back(CDNSSeedData("multifart.org", "seed2.multifart.org"));

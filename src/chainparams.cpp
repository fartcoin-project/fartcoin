...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.fartcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.fartcointools.com");
        vSeeds.emplace_back("dnsseed.fartcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.fartcointools.com");
        vSeeds.emplace_back("seed-b.fartcoin.loshan.co.uk");

...
const char * const BITCOIN_CONF_FILENAME = "fartcoin.conf";
const char * const BITCOIN_PID_FILENAME = "fartcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fartcoin";
#else
    // Unix

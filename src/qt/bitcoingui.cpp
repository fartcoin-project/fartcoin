    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fartcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&FART"), this);
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&SMELL"), this);
    ...
    historyAction = new QAction(QIcon(":/icons/history"), tr("&PAST"), this);
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Fartcoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Fartcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fartcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fartcoin Core"));
    ...
    changePassphraseAction->setStatusTip(tr("Change the password used for wallet encryption"));
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your Fartcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fartcoin addresses"));
    ...
    usedSendingAddressesAction = new QAction(QIcon(":/icons/address-book"), tr("Fart &sending addresses..."), this);
    usedSendingAddressesAction->setStatusTip(tr("Show the list of used sending addresses and labels"));
    usedReceivingAddressesAction = new QAction(QIcon(":/icons/address-book"), tr("Fart &receiving addresses..."), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Fartcoin Core help message to get a list with possible command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Fartcoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Fartcoin client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fartcoin network", "", count));
}
...
{
    QString strTitle = tr("Fartcoin"); // default title
...
void BitcoinGUI::incomingTransaction(const QString& date, int unit, qint64 amount, const QString& type, const QString& address)
{
    ...
    message((amount)<0 ? tr("Sent farts") : tr("Incoming farts"),
             tr("Date: %1\n"
                "Amount: %2\n"
                "Type: %3\n"
                "Address: %4\n")

...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MFART);
    unitlist.append(kFART);
    unitlist.append(FART);
    unitlist.append(Farticle);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MFART: return QString("MFART");
    case kFART: return QString("kFART");
    case FART: return QString("FART");
    case Farticle: return QString("Farticle");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MFART: return QString("Mega-Fart (1,000,000 FART)");
    case kFART: return QString("Kilo-Fart (1000 FART)");
    case FART: return QString("Fart");
    case Farticle: return QString("Farticle (1 / 100,000,000");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MFART: return Q_INT64_C(100000000000000);
    case kFART: return Q_INT64_C(100000000000);
    case FART:  return Q_INT64_C(100000000);
    case Farticle: return Q_INT64_C(1);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MFART: return Q_INT64_C(900000);
    case kFART: return Q_INT64_C(900000000);
    case FART:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
    case Farticle: return Q_INT64_C(9000000000000000000); // Slightly under max value for int64
    default:   return 0;
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MFART: return 6;  // 900,000 (# digits, without commas)
    case kFART: return 9;  // 900,000,000
    case FART:  return 12; // 900,000,000,000
    case Farticle: return 19; // 9,000,000,000,000,000,000
    default: return 0;
    }
}
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case MFART: return 14;
    case kFART: return 11;
    case FART: return 8;
    case Farticle: return 0;
    default: return 0;
    }
}

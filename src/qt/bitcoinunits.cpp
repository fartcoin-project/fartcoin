...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("mFART");
    case uBTC: return QChar(0x03BC) + QString("FART");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-Fartcoins (1,000,000)");
    case kBTC: return tr("Kilo-Fartcoins (1,000)");
    case BTC: return tr("Fartcoins");
    case mBTC: return tr("Milli-Fartcoins (1 / 1,000)");
    case uBTC: return tr("Micro-Fartcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}

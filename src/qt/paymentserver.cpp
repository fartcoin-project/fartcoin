...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("fartcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'fartcoin://' is not a valid URI. Use 'fartcoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Fartcoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);

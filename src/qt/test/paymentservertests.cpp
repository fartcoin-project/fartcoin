...
// Copyright (c) 2020 The Fartcoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Fartcoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Fartcoin (as there is no actual maximum coins)

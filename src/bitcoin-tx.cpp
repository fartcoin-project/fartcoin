...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fartcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fartcoin-tx [options] <hex-tx> [commands]  Update hex-encoded fartcoin transaction\n" +
            "or:     fartcoin-tx [options] -create [commands]   Create hex-encoded fartcoin transaction\n" +
            "\n";

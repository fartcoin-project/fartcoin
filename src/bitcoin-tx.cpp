...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s fartcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fartcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fartcoin transaction") + "\n" +
              "  fartcoin-tx [options] -create [commands]   " + _("Create hex-encoded fartcoin transaction") + "\n" +
              "\n";

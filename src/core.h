...
// FartCoin aux chain ID = 0x0062 (98)
...
static const int64_t MAX_MONEY = 300000000 * COIN; // Fartcoin: maximum of 300M coins (given some randomness)
...
public:
    ...
    {
        // Fartcoin: IsDust() detection disabled, allows any valid dust to be relayed.

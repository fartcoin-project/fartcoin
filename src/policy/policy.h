...
/** Recommended transaction fee by Fartcoin Core developers
  *
 ...
 *
 *  Fartcoin:    Increment mempool limits and accept RBF in steps of 0.0001 FART
...
/**
 * Fartcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Fartcoin: Default hard dust limit that is evaluated when considering whether

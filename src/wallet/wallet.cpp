        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Fartcoin: Disable free transactions
...
{
    // Fartcoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Fartcoin: Add an increased fee for each dust output
        nFeeNeeded += GetFartcoinDustFee(tx.vout, minTxFee);
    }

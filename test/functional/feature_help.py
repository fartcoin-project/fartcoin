...
"""Verify that starting fartcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fartcoin with -h for help text")
        ...
        self.log.info("Start fartcoin with -version for version information")
        ...
        self.log.info("Start fartcoind with -fakearg to make sure it does not start")

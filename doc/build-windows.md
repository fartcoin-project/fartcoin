...
Note that for WSL v1 the Fartcoin Core source path MUST be somewhere in the default mount file system, for
example /usr/src/fartcoin, AND not under, for example, /mnt/d/fartcoin. 

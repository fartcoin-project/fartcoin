# Support for Output Descriptors in Fartcoin Core

Since Fartcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Fartcoin Core wallets, a convenience function `combo` is

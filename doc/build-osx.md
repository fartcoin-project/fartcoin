...
1. Clone the Fartcoin Core source code:
    ```shell
    git clone https://github.com/fartcoin-project/fartcoin
    cd fartcoin
    ```

2.  Build Fartcoin Core:

    Configure and build the headless Fartcoin Core binaries as well as the GUI (if Qt is found).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Fartcoin Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Fartcoin"

touch "/Users/${USER}/Library/Application Support/Fartcoin/fartcoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Fartcoin/fartcoin.conf"
```

The first time you run fartcoind, it will start downloading the blockchain. This process could

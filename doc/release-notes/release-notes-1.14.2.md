Fartcoin Core version 1.14.2 is now available from:

  <https://github.com/fartcoin/fartcoin/releases/tag/v1.14.2/>
...
Fartcoin Core introduces pruning the blockchain in 1.14. Pruning
...
Since 1.14.0 the approximate transaction fee shown in Fartcoin-Qt when using coin

...
*Setup instructions for a gitian build of Fartcoin using a Debian VM or physical system.*
...
- [Building Fartcoin](#building-fartcoin)
...
Clone the git repositories for fartcoin and gitian,
...
In [doc/release-process.md](release-process.md) in the fartcoin repository under 'Fetch and build inputs'.
...
To build Fartcoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the fartcoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/fartcoin/.git/
...
For example:
```bash
URL=https://github.com/langerhans/fartcoin.git
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/fartcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/fartcoin-build.assert
```
...
[fartcoin/gitian.sigs](https://github.com/fartcoin/gitian.sigs/) repository, or

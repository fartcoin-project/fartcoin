...
Follow the instructions in [doc/release-process.md](release-process.md) in the fartcoin repository
...
To build Fartcoin (for Linux, OSX and Windows) just follow the steps under 'perform
...
[fartcoin/gitian.sigs](https://github.com/fartcoin/gitian.sigs/) repository, or if that's not possible create a pull request. 

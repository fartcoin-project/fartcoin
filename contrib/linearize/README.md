# Linearize
Construct a linear, no-fork, best version of the Fartcoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install fartcoin_hash

https://github.com/fartcoin-project/fartcoin_hash
...
JSON-RPC server. Running `fartcoind` or `fartcoin-qt -server` will be sufficient.
...
* `input`: fartcoind blocks/ directory containing blkNNNNN.dat

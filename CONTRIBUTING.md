...
The Fartcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Fartcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/fartcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to fartcoin-qt
...
The following applies to code changes to the Fartcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Fartcoin
Network Protocol consensus changes.

Whether a pull request is merged into Fartcoin Core rests with the project merge
...
Patches that change Fartcoin consensus rules are considerably more involved than
...
The project leader is the release manager for each Fartcoin Core release.

# Contributing to Fartcoin Core

Fartcoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/fartcoin/fartcoin/labels/help%20wanted)
* [Projects](https://github.com/fartcoin/fartcoin/projects)
* [Fartcoindev on reddit](https://www.reddit.com/r/fartcoindev/)

## Branch Strategy

Fartcoin Core's default branch is intentionally a stable release, so that anyone
...
Fartcoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Fartcoin Core
releases will automatically benefit from these.

When refactoring Fartcoin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Fartcoin Core, and is not to be
confused with overall Fartcoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Fartcoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Fartcoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Fartcoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Fartcoin consensus, it must have been

...
# Copyright (c) 2014 The Fartcoin Core developers
...
# B1 should still be able to spend 1000000 (-1 FART fee for the successful transaction), because D is conflicted

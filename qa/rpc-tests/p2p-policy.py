#!/usr/bin/env python3
# Copyright (c) 2021-2022 The Fartcoin Core developers
...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Fartcoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Farticle expressed in FART
        ten = Decimal("10.0")                  # uniform 10 FART seed moneys
        ...
        # create a bunch of UTXO with seed money from the Fartcoin Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 FART output and 1 FART fee
    ...
    # spend seed money with a key not in the Fartcoin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Fartcoin Core raw tx APIs
        ...
        # and send the tx from there rather than from Fartcoin Core, to test
